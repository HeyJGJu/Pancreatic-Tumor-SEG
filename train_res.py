...
ckpt_path = '/disk/sdc/tanxin/network/CVPR2021_PFNet-main/checkpoint'
exp_name = 'PFNet_res'
...
def main():
    ...
    net.load_state_dict(torch.load('/disk/sdc/tanxin/network/CVPR2021_PFNet-main/checkpoint/PFNet_res/200.pth'))
