...
def main():
    ...
    net.load_state_dict(torch.load('/disk/sdc/tanxin/network/CVPR2021_PFNet-main/checkpoint/PFNet_res/1800.pth'))
    print('Load {} succeed!'.format('/disk/sdc/tanxin/network/CVPR2021_PFNet-main/checkpoint/PFNet_res/1800.pth'))
